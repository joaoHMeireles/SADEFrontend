                ...
                {valor == 0 &&
                    <>
                        ...
                        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", width: "100%", marginTop: 5 }}>
                            <BotaoTerciario sx={{ width: "15%", height: "3rem" }} variant='outlined' onClick={() => { window.location.href = "/home" }}>Cancelar</BotaoTerciario>
                            <BotaoPrimario sx={{ width: "15%", height: "3rem" }} variant='contained' endIcon={<ArrowForwardIosRoundedIcon sx={{ width: "15px" }} />} onClick={() => { setValor(1) }}>Proximo</BotaoPrimario>
                        </Box>
                    </>
                }
                {
